...
#@jit(nopython = True)
def gravity_spherical_harmonic(x, r_planet, mu, c, s, n_max, m_max, normal_par):
    """
    ...
    acc = _gottlieb(x, r_planet, mu, c, s, n_max, m_max, normal_par)

    return acc

def _gottlieb(x, r_planet, mu, c, s, n_max, m_max, normal_par):
    norm1, norm2, norm11, normn10, norm1m, norm2m, normn1 = normal_par
